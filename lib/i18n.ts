...
const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    unsorted: 'Unsorted',
    unsortedSubtitle: 'Auto-captured from your ChatGPT / Claude sidebar · drag into a space.',
    ...
    helpQuickStart4:
      'On any chatgpt.com or claude.ai page, click the floating SpaceMind button in the bottom-right corner (or press Cmd+Shift+K) to save the current conversation into a space.',
    ...
    helpKbdOverlay: 'Cmd+Shift+K — save the current page on chatgpt.com / claude.ai (or click the floating button)',
  ...
  'zh-CN': {
    ...
    unsorted: '未分类',
    unsortedSubtitle: '自动从你的 ChatGPT / Claude 侧边栏捕获 · 拖入空间归类。',
    ...
    helpQuickStart4: '在 chatgpt.com 或 claude.ai 页面,点击右下角的 SpaceMind 悬浮按钮(或按 Cmd+Shift+K),把当前对话保存到某个空间。',
    ...
    helpKbdOverlay: 'Cmd+Shift+K —— 在 chatgpt.com / claude.ai 上保存当前对话(也可点击右下角悬浮按钮)',
